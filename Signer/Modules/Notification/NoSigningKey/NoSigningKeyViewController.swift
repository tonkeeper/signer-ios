...
final class NoSigningKeyViewController: BasicViewController, TKBottomSheetContentViewController {
  private let viewModel: NoSigningKeyViewModel
  
  private let modalCardViewController = TKModalCardViewController()
  
  // MARK: - Init
  
  init(viewModel: NoSigningKeyViewModel) {
...
private extension NoSigningKeyViewController {
  func setup() {
